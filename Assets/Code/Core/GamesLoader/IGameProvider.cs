...
namespace Code.Core.GamesLoader
{
    ...
    public interface IGameProvider : IDisposable
    {
        ...
        /// <summary>
        /// Gets the games loader
        /// </summary>
        IGamesLoader GamesLoader { get; }
        
        /// <summary>
        /// Gets the queue service
        /// </summary>
        IGameQueueService QueueService { get; }
        ...
        /// <summary>
        /// Initializes the provider with all required services
        /// </summary>
        /// <param name="gameRegistry">Game registry</param>
        /// <param name="queueService">Game queue service</param>
        /// <param name="gamesLoader">Games loader</param>
        /// <param name="cancellationToken">Cancellation token</param>
        ValueTask InitializeAsync(IGameRegistry gameRegistry, IGameQueueService queueService, IGamesLoader gamesLoader, CancellationToken cancellationToken = default);
