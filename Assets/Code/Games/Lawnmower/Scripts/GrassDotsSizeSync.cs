...
namespace Code.Games.Lawnmower.Scripts
{
    internal class GrassDotsSizeSync : MonoBehaviour
    {
        ...
        [SerializeField] private Camera cam; // можно не задавать Ч возьмЄм main
        ...
        void LateUpdate()
        {
            ...
            // ћер€ем экранный размер рендера в пиксел€х
            var b = sr.bounds;
            Vector3 c = b.center;
            ...
            // ширина/высота всего спрайта (умножаем на 2, т.к. мерили от центра до кра€)
            wPx *= 2f;
            hPx *= 2f;
