...
internal class BlockSpawner : MonoBehaviourDisposable
{
	...
	private void SpawnNextMovingBlock()
	{
		...
		var newSize = LastPlacedBlockData.size;
	...
	{
		var height = LastPlacedBlockData.center.y + LastPlacedBlockData.size.y * 0.5f + blockSize.y * 0.5f + blockSpacing;
	...
	public PlaceResult TryPlaceCurrent()
	{
		...
		var result = BlockSlicer.TryPlace(LastPlacedBlockData, currentBlockData);
