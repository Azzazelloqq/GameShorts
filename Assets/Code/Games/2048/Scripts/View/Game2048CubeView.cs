...
namespace Code.Games._2048.Scripts.View
{
    internal class Game2048CubeView : BaseMonoBehaviour
    {
        ...
        public void MoveLeft()
        {
            ...
            currentPosition.x -= _ctx.moveSpeed * Time.deltaTime;
            currentPosition.x = Mathf.Max(currentPosition.x, -1);
            _transform.position = currentPosition;
        }
        
        /// <summary>
        /// Перемещает куб вправо
        /// </summary>
        public void MoveRight()
        {
            ...
            Vector3 currentPosition = _transform.position;
            currentPosition.x += _ctx.moveSpeed * Time.deltaTime;
            currentPosition.x = Mathf.Min(currentPosition.x, 1);
            _transform.position = currentPosition;
        }
