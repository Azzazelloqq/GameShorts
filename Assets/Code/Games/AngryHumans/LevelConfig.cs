...
namespace Code.Games.AngryHumans
{
    ...
    public class LevelConfig : ScriptableObject
    {
        ...
        private Color _backgroundColor = new Color(0.5f, 0.7f, 1f, 1f);
        ...
        {
            // Убеждаемся, что очки идут по возрастанию
            ...
            // Базовая награда не может быть отрицательной
            if (_baseReward < 0)
                _baseReward = 0;
            
            // Множитель должен быть положительным
